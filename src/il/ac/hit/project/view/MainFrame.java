...
import il.ac.hit.project.model.command.*;
...
public class MainFrame extends JFrame {
    ...
    private final CommandManager cmd = new CommandManager();
    //shows tasks
    ...
    private JComponent buildCrudBar() {
        ...
        deleteAll.addActionListener(e -> {
            ...
            if (ok == JOptionPane.YES_OPTION) {
                cmd.execute(new DeleteAllTasksCommand(vm));
            }
        });
        ...
        del.addActionListener(e -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                var command = new DeleteTaskCommand(vm, selectedId);
                cmd.execute(command);
            }
        });
        ...
        prio.addActionListener(e -> {
            ...
            try {
                cmd.execute(new ChangePriorityCommand(vm, id, Priority.valueOf(chosen)));
            } catch (Exception ex) {
